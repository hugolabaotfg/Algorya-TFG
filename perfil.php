...
// =============================================================================
// ALGORYA - perfil.php
// Área privada del cliente: historial de pedidos + accesos a ajustes de cuenta.
// Correcciones aplicadas:
//   - Modo oscuro nativo mediante variables CSS de estilos.css (sin colores hardcodeados)
//   - Marca actualizada a Algorya
//   - Sistema i18n integrado (ES/EN)
//   - Prepared statements en las consultas SQL
//   - Navbar unificado con el resto de la web
// =============================================================================
...
// Solo usuarios logueados pueden acceder al perfil
...
// Obtener historial de pedidos del usuario, ordenado del más reciente al más antiguo
...
// Letra inicial del avatar (primera letra del nombre en mayúscula)
...
<head>
    ...
    <!--
        ...
        1. Bootstrap CSS  → define las clases base
        2. Bootstrap Icons → iconos
        3. estilos.css    → sobreescribe con variables CSS premium + modo oscuro
        tema.js se carga AL FINAL del body, después de Bootstrap JS,
        porque necesita que el DOM esté listo para leer/escribir data-bs-theme
    -->
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container my-5 flex-grow-1">
        ...
        <!-- CABECERA DEL PERFIL
         Antes usaba: background: linear-gradient(135deg, #111 0%, #333 100%); color: white;
         Ahora usa:   clases premium-card + variables CSS → respeta el modo oscuro automáticamente -->
        ...
        <!-- DOS COLUMNAS: Ajustes (izquierda) + Pedidos (derecha) -->
        <div class="row g-4">
                ...
                <div class="card premium-card border-0 rounded-4 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold premium-text mb-3">
                            <i class="bi bi-gear text-primary me-2"></i>Ajustes de Cuenta
                        </h5>

                        <!-- Lista de accesos a secciones de ajustes -->
                ...
                <div class="card premium-card border-0 rounded-4 shadow-sm h-100">
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold premium-text mb-4">
                            <i class="bi bi-box-seam text-primary me-2"></i>Mi Historial de Pedidos
                        </h5>
                                        ...
                                        <?php while ($pedido = $res_pedidos->fetch_assoc()): ?>
                                            <tr style="border-bottom: 1px solid var(--border-color);">
                                                ...
                                                <td class="text-center py-3">
                                                    <span class="badge rounded-pill px-3 py-2 fw-semibold" style="background:rgba(34,197,94,0.12);
                                                     color:#16a34a;
                        ...
                        <?php else: ?>
                            ...
                            <!-- Estado vacío: ningún pedido realizado todavía -->
                            <div class="text-center py-5">
                                <i class="bi bi-cart-x fs-1 premium-muted d-block mb-3"></i>
                                <h6 class="fw-bold premium-text">Aún no has realizado ninguna compra</h6>
